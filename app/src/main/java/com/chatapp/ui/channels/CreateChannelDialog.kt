...
import com.example.chatapp.databinding.DialogChannelNameBinding
...
class CreateChannelDialog : DialogFragment() {
    ...
    private val dialogViewModel: ChannelViewModel by activityViewModels()
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return MaterialAlertDialogBuilder(requireContext())
            ...
            .setPositiveButton(R.string.create) { _,_ ->
                dialogViewModel.createChannel(binding.etChannelName.text.toString())
            }
